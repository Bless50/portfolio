...
export const PROJECTS: Project[] = [
  ...
  {
    id: "ghl-stripe-membership",
    track: "va",
    title: "Membership Access-Control & Live Stripe Billing",
    tagline: "Automated subscription onboarding, license gating, and failed payment recovery",
    category: "Memberships & Payment Ops",
    year: "2025",
    featured: true,
    tags: ["GoHighLevel Memberships", "Stripe Integration", "Webhooks", "Customer Portal"],
    metrics: ["Zero Manual Admin", "<10s Onboarding Access", "Automated Dunning"],
    toolsUsed: ["GoHighLevel Memberships", "Stripe Billing", "Webhooks", "Customer Self-Service"],
    projectBrief:
      "A paid coaching community needed a secure membership gate that instantly grants course and portal access upon successful payment, and automatically revokes access if a subscription is cancelled or unpaid.",
    workflowHighlights: [
      "Integrated live Stripe checkout webhooks with GHL membership workflows to provision immediate login credentials upon payment.",
      "Configured automated dunning workflows that send courteous payment retry reminders before subscription suspension.",
      "Built a self-serve billing portal reducing customer support payment inquiries by over 70%.",
    ],
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
  },
  {
...
export const EXPERIENCES: ExperienceItem[] = [
  {
    ...
    highlights: [
      ...
      "Built membership access-control workflows with live Stripe integration and a Shopify-to-GHL purchase automation pipeline syncing customer order data.",
      "Selected into the program's paid phase after a standout Custom Objects build among a 23-person cohort.",
    ],
    stack: ["GoHighLevel", "Custom Objects", "Conversation AI", "Stripe", "Shopify", "Make.com", "Zapier"],
  },
  {
